...
3. Power Supply Unit
   Voltage Regulator (e.g., LM2591HVS-12): Steps down the main battery voltage (e.g., 15V) to a stable 12V for the LiDAR.
...
**BOM：**[WS1 - Power - Sample BOM.xlsx](<./WS1%20-%20Power%20-%20Sample%20BOM.xlsx>)[github.com/Yu-Peng-Tu/Lab2-submission.git](https://github.com/Yu-Peng-Tu/Lab2-submission.git)
